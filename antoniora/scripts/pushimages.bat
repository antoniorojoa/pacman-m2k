...
echo "pushing image pacman"
%CONTAINER_RUNTIME% tag pacman %REGISTRY_URL%/%REGISTRY_NAMESPACE%/pacman
%CONTAINER_RUNTIME% push %REGISTRY_URL%/%REGISTRY_NAMESPACE%/pacman
